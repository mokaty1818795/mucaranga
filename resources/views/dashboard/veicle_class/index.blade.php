                ...
                <div class="card">
                    <div class="card-header row justify-content-between">
                        ...
                        <a href="{{ route('veicle_class.create') }}" class="col-auto btn btn-purple">
                            @svg('fluentui-contact-card-ribbon-16-o','feather align-middle') &nbsp; <span class="align-middle">Novo tipo de carta</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <table id="veicle_classes_table" class="table table-responsive display table-hover my-0 w-100">
                            <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nome da carta</th>
