    ...
    <form action="" method="post" id="student_registration_payment"  enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <select class="form-select form-control" name="document_type" wire:model="paymentPhaseId" id="paymentPhaseId">
            ...
            <div class="col-md-6"><label for="Carregar documento">Valor a pagar</label>
                <input type="text" name="amount"  class="form-control" disabled value="{{$amount}} MZN">
            </div>
        </div>
    </form>
